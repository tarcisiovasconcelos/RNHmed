...
import { StyleSheet, View, Text , ImageBackground, ActivityIndicator, YellowBox } from 'react-native';
...
export function Login (props: LoginProps) {
    ...
    const login = async (dados:any) => {
        ...
        if (dados.email == 'tarcisioclovis@gmail.com' && dados.senha == '123456')
          ...
          setErro('Sua conta ou senha está incorreta.')
    }
    ...
    return (
      ...
      <TouchableOpacity onPress={() => nav.navigate('Tela-Desafio')}>
